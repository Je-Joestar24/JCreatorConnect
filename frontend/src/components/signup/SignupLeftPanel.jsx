    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {role ? (role === 'creator' ? 'Start Creating' : 'Start Supporting') : 'Join JCreatorConnect'}
          </Typography>
        </motion.div>
        ...
        >
          ...
          >
            {role
              ? role === 'creator'
                ? 'Share your creativity, build your community, and receive support from your audience.'
                : 'Discover amazing creators, unlock exclusive content, and support the work you love.'
              : 'Connect with creators, support their work, and be part of a thriving creative community.'}
          </Typography>
        </motion.div>
      </Box>
    </Box>
