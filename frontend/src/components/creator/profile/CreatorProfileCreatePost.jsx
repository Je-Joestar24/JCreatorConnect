...
/**
 * Creator Profile Create Post Component
 * Displays a "What's on your mind?" input area similar to Facebook
 * Only visible for own profile
 */
const CreatorProfileCreatePost = ({ isOwnProfile, onPostCreated }) => {
      ...
      >
        <Box
          sx={{
            ...
            boxShadow: isFocused ? 'var(--theme-shadow-md)' : 'none',
          }}
        >
          {/* Input Area */}
          <Box
...
export default CreatorProfileCreatePost;
